...
public class MisteriosActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numeroDia == 1 || numeroDia == 4){
            ...
            mis.setCita("Pero él les dijo: No teneis que asustaros: vosotros venis a buscar a Jesus de Nazaret, que fue crucificado, ya resucitó no esta aqui mirad el lugar donde lo pusieron (San Marcos 16,6)");
            ...
            mis.setCita("Asi, el Selir Jesus, despues de haberles hablado varias veces, fue elevado al cielo por su propia virtud, y está alli sentado a la diestra de Dios. (San Marcos 16, 19)");
            ...
            mis.setCita("Entonces fueron llenados todos del Espiritu Santo y comenzaron a hablar en nuevas lenguas las palabras que el Espiritu Santo ponia en su boca. (Hechos de los Apostoles 2,4)");
            ...
            mis.setCita("Y en esto apareció un gran prodigio en el cielo una mujer vestida de sol, y la luna debajo de sus pies, y en su cabeza una corona de doce estrellas. (Apocalipsis 12, 1)");
            ...
            mis.setNombre("LA CORONACION DE NUESTRA SEÑOS");
            mis.setCita("Tu eres la gloria de Jerusalen, tu la alegria de Israel, tu la honra de nuestra nacion. Porque te has portado con varonil esfuerzo, y has tenido un corazon constante. (Judith 15, 9-11");
        ...
        if (numeroDia == 2 || numeroDia == 7 ){
            ...
            mis.setCita("Y habiendo entrado el ángel a donde ella estaba, le dijo: Dios te salve llena eres de gracia, el Señor es contigo: bendita tú eres entre las mujeres. (San Lucas 1,28)");
            ...
            mis.setCita("Lo mismo fue oir la salutacion de Maria, que la criatura dar saltos de placer en su vientre; y exclamando en alta voz dijo a Maria; Bendita tu eres entre todas las mujeres y bendito es el fruto de tu vientre. (San Lucas 1, 41-42) ");
            ...
            mis.setCita("Y dio a luz a su hijo primogenito, y envolviolo en pañales y lo recostó en un pesebre por que no hubo lugar para ellos en la posada. (San Lucas 2,7)");
            ...
            mis.setCita("Cumplido, asi mismo, el tiempo de la purrificacion de la madre, segun la ley de Moises llevaron al Niño a Jerusalen para presentarlo al Señor, como esta escrito en la ley del Señor. Todo primogenito varon sera consagrado al Señor. (San Lucas 2, 22-23)");
            ...
            mis.setCita("Y al cabo de tres dias de haberle perdido le hallaron en el templo, sentado en medio de los doctores a quienes escuchaban y preguntaban. (San Lucas 2,46)");
        ...
        if (numeroDia == 3 || numeroDia == 6){
            ...
            mis.setCita("Y viniendole un sudor como de gotas de sangre que chorreaba hasta el suelo. Y levantandose de la oracion, y viniendo a sus discipulos los hallo dormidos por causa de la tristeza. (San Lucas 22, 44-47)");
